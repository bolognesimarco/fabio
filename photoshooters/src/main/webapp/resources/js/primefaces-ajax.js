...
//                	alert("senza view state:"+form.id);
...
//	alert("chiamata ajax viewstate");
    if (typeof xhr.responseXML != 'undefined') { 
    	// It's undefined when plain $.ajax(), $.get(), etc is used instead of PrimeFaces ajax.
